...
public class CetakDataKamar extends javax.swing.JFrame {
    ...
    public void Cetak(){
        String html = "<H4><center>Laporan Data Kamar Rumah Sakit Umum Taruna</center></h4>"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakDataKamar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
